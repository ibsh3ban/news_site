            ...
            <form>
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="first_name" name="firts_name" placeholder="Enter author first_name">
                </div>
                <div class="form-group">
              ...
              <div class="card-footer">
                <button type="button" onclick="performStore()" class="btn btn-primary">Add author</button>
