          ...
          <div class="card card-primary">
            ...
            <form>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  <label for="descreption">description of slider</label>
              ...
              <div class="card-footer">
                ...
                <a href="{{ route('zliders.index') }}" type="button" class="btn btn-info">Return Back</a>
...
@section('scripts')
  <script>
    function performStore(){
      ...
      store('/cms/admin/zliders' , formData);
    }
